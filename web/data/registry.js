window.__REGISTRY__ = [
  {
    ...
    "challenge": {
      ...
      "notes": [
        ...
        "Tier-weighting note: the knowledge_assistant profile now implements the paper's Section 3.3 rule over all 12 dimensions, so data_sensitivity=2 (internal documents) drives this entry to medium. It tiered low until 2026-08-17 under the superseded v1.1 five-dimension subset (autonomy, action_authority, blast_radius, persistence, reversibility — all Tier 1 here), which is retained as legacy_knowledge_assistant_v1_1. See docs/adr/0019-*.md."
      ]
    },
    "dimensions": {
      "action_authority": {
  ...
  },
  {
    ...
    "challenge": {
      ...
      "notes": [
        ...
        "Unchanged by the 2026-08-17 alignment of the per-type profiles to the paper's Section 3.3 all-12 rule (docs/adr/0019-*.md): the tier stays Tier 2, and the published value is now reproduced by the current rule rather than by the superseded v1.1 five-dimension subset. The recorded driver set widened to every dimension scored at 2."
      ]
    },
    "dimensions": {
      "action_authority": {
  ...
  },
  {
    ...
    "challenge": {
      ...
      "notes": [
        "Curated, human-authored reference entry; scores reasoned by hand against the ARC 12-dimension model. No automated challenger pass was run.",
        "Tier-weighting note: the tool_using_agent profile now implements the paper's Section 3.3 rule over all 12 dimensions, so data_sensitivity=3 (regulated identity PII) forces Tier 3 (high) under worst-case-wins. This entry tiered medium until 2026-08-17, driven by blast_radius=2, under the superseded v1.1 five-dimension subset that excluded data_sensitivity — the concrete case that made the divergence in docs/adr/0012-*.md visible. RAI confirmed on 2026-08-16 that the subset formulas are outdated; the superseded weighting is retained as legacy_tool_using_agent_v1_1. See docs/adr/0019-*.md."
      ]
    },
    "dimensions": {
      "action_authority": {
